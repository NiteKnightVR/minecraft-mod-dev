...
public class ItemExplodingBow extends Item
{
    ...
    public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_)
    {
        ...
        if (flag || p_77615_3_.inventory.hasItem(ExampleMod.explodingArrow))
        {
    ...
    {
        this.itemIcon = p_94581_1_.registerIcon("examplemod:" + this.getUnlocalizedName().substring(5) + "_standby");
        this.iconArray = new IIcon[bowPullIconNameArray.length];

        for (int i = 0; i < this.iconArray.length; ++i)
        {
            this.iconArray[i] = p_94581_1_.registerIcon("examplemod:" + this.getUnlocalizedName().substring(5) + "_" + bowPullIconNameArray[i]);
        }
    }
