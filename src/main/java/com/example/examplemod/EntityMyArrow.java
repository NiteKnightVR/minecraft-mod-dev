...
public class EntityMyArrow extends Entity implements IProjectile
{
    ...
    public EntityMyArrow(World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public EntityMyArrow(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_)
    {
        super(p_i1754_1_);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityMyArrow(World p_i1755_1_, EntityLivingBase shooter, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityMyArrow(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
            ...
            if (block == this.field_145790_g && j == this.inData)
            {
                ...
                if (this.ticksInGround == 1)
                {
                    EntityLightningBolt light = new EntityLightningBolt
                            (this.worldObj, this.posX,
                                    this.posY, this.posZ);
                    this.worldObj.addWeatherEffect(light);
                    this.setDead();
                }
            }
            else
