...
public class BlockMetalworkingBench extends Block
{
    ...
    public void registerBlockIcons (IIconRegister iconRegister) {
        this.blockIcon = iconRegister.registerIcon(MyMod.MODID + ":" + "metalworking_bench_side");
        this.metalworkingBenchTop = iconRegister.registerIcon(MyMod.MODID + ":" + "metalworking_bench_top");
    }
                                     ...
                                     float hitY, float hitZ)
    {
        ...
        if (!player.isSneaking()) {
            player.openGui(MyMod.instance, MyMod.guiIDMetalworkingBench, world, x, y, z);
            return true;
        }else{
            return false;
        }
